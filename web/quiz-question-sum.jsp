      ...
      <div style="padding: 4rem" class="background">
        ...
        <script>
          let quiz = [
            ...
            {
              text1: 'bagian atas ya',
              question: 'images/Sum-Q-2.png',
          ...
          for(let i=0; i<quiz.length;i++) {
            ...
            if(quiz[i].type === 'text'){
              ...
              quizHtml +=   '<div class="d-flex column padding-10" style="border: 1px solid black;"><div><p class="header-3">'+ question +'</p><div class="container"><img src="'+ question_image +'" alt=""></div>'
              for(let j=0;j<arrAnswer.length;j++){
                let newId = i + ''
                newId = newId + j
                let answer =    '<div id="answer' + i+' " 0="" class="mt-2 radio"><input type="radio" value="'+(j + 10)+'" name="radio' + i +'" id="radio' + newId +'" class="mr-2 radio__input"><label for="radio'+i+'" class="radio__label"><img class="answer-image" src="'+arrAnswer[j]+'"></label></div></div>'
                quizHtml += answer
              }
                quizHtml += '</div></div></div>'
            } 
