          ...
          <ul class="nav-list">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-content">
                ...
                <a href="material5.jsp" class="nav-link current">4.2.5 Menguji Atur Cara dan Membaiki Ralat</a>
        ...
        <div class="padding-10 container">
          <div style="padding-top: 20px;" class="container">
            ...
            <div style="margin-top: 20px;" class="d-flex flex-center">
              <button class="btn-icon mr-2"><a href="material4.jsp"><i class="fas fa-arrow-left"></i></a></button>
              <iframe class=" mr-2" style="width: 1080px; height: 1000px;" src="assets/pdf-example.pdf"></iframe>
              <button class="btn-icon"><a href="material6.jsp"><i class="fas fa-arrow-right" ></i></a></button>
            </div>
            <a  style="float: right;" href="quiz-question5.jsp" class="btn">Attempt Quiz</a>
          </div>
        </div>
      </section>
    </main>
