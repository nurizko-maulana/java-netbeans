    ...
    <main>
      <div style="padding: 4rem" class="background">
        ...
        <script>
          let quiz = [
            {
              question: 'Nyatakan tiga kebaikan menggunakan function dan procedure dalam penulisan satu',
              type: 'text',
            ...
            {
              question: 'images/Debugz Logo.png',
              type: 'image-question',
        ...
        <div class="d-flex" style="align-items: flex-end;">
          ...
          <a href="result.jsp" class="btn" style="margin-left: auto;" onclick="calculation();">Submit</a>
        </div>
