<%-- 
    Document   : account
    Created on : Dec 21, 2020, 9:05:25 PM
    Author     : zahra_afa
--%>
          ...
          <div class="padding-10 rounded background-white light-shadow">
            ...
            <div class="d-flex column">
              ...
              <div class="d-flex">
                ...
                <button style="width: 100px;" class="mt-3 mr-2 button-1 color-primary rounded"><a class="color-primary" href="edit-account.jsp" >Edit Account</a></button>
              </div>
              <hr class="mt-3">
