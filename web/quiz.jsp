<%-- 
    Document   : quiz
    Created on : Dec 21, 2020, 9:09:25 PM
    Author     : zahra_afa
--%>
    ...
    <section class="hero">
      <div style="width: 100%; height: 60vh; display: flex; justify-content: center; align-items: center; max-width: 80rem; margin: auto; padding: 2rem;">
        <div id="home" class="flex-column flex-center">
          <h1 style="font-size: 5.4rem; color: #fafafa; margin-bottom: 5rem; font-family: "Aldrich", sans-serif;">Are You Ready?</h1>
          <a href="quiz-question-sum.jsp" class="btn">START!</a>
          <a href="material1.jsp" id="back-btn" class="btn">Back to Material</a>
        </div>
      </div>
    </section>
  </main>
