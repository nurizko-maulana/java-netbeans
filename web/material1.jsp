<%-- 
    Document   : material1
    Created on : Dec 21, 2020, 9:07:05 PM
    Author     : zahra_afa
--%>
          ...
          <ul class="nav-list">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-content">
                <a href="material1.jsp" class="nav-link current">4.2.1 Fungsi Function dan Procedure dalam Atur Cara</a>
      ...
      <section class="background">
        <div class="padding-10 container">
          <div style="padding-top: 20px;" class="container">
            <h3 class="color-white">4.2.1 Fungsi Function dan Procedure dalam Atur Cara</h3>
            <div style="margin-top: 20px;" class="d-flex flex-center">
              ...
              <button class="btn-icon"><a href="material2.jsp"><i class="fas fa-arrow-right" ></i></a></button>
            </div>
            <a  style="float: right;" href="quiz-question.jsp" class="btn">Attempt Quiz</a>
          </div>
        </div>
      </section>
    </main>
