    ...
    <main>
      <div style="padding: 4rem" class="background">
        ...
        <script>
          let quiz = [
            {
              question: 'Apakah teknik-teknik pemikiran komputasional yang digunakan semasa fasa analisis masalah?',
              type: 'text',
              answer: ['Teknik pengecaman corak', 'Teknik leraian', 'Teknik pengecaman corak', 'Teknik pengitlakan'],
              correctAnswer: 2
            }
          ]
        ...
        <div class="d-flex" style="align-items: flex-end;">
          ...
          <a href="result4.jsp" class="btn" style="margin-left: auto;" onclick="calculation();">Submit</a>
        </div>
