          ...
          <ul class="nav-list">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-content">
                ...
                <a href="guest-material3.jsp" class="nav-link current">4.2.3 Menulis Pernyataan Function dan Procedure</a>
        ...
        <div class="padding-10 container">
          <div style="padding-top: 20px;" class="container">
            ...
            <div style="margin-top: 20px;" class="d-flex flex-center">
              <button class="btn-icon mr-2"><a href="guest-material2.jsp"><i class="fas fa-arrow-left"></i></a></button>
              <iframe class=" mr-2" style="width: 1080px; height: 1000px;" src=".../assets/pdf-example.pdf"></iframe>
              <button class="btn-icon"><a href="guest-material4.jsp"><i class="fas fa-arrow-right" ></i></a></button>
            </div>
