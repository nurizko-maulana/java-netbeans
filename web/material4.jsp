          ...
          <ul class="nav-list">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-content">
                ...
                <a href="material4.jsp" class="nav-link current">4.2.4 Menulis Atur Cara yang Melibatkan Function dan Procedure</a>
      ...
      <section class="background">
        <div class="padding-10 container">
          <div style="padding-top: 20px;" class="container">
            <h3 class="color-white">4.2.4 Menulis Atur Cara yang Melibatkan Function dan Procedure</h3>
            <div style="margin-top: 20px;" class="d-flex flex-center">
              <button class="btn-icon mr-2"><a href="material3.jsp"><i class="fas fa-arrow-left"></i></a></button>
              <iframe class=" mr-2" style="width: 1080px; height: 1000px;" src="assets/pdf-example.pdf"></iframe>
              <button class="btn-icon"><a href="material5.jsp"><i class="fas fa-arrow-right" ></i></a></button>
            </div>
            <a  style="float: right;" href="quiz-question4.jsp" class="btn">Attempt Quiz</a>
          </div>
        </div>
      </section>
    </main>
